...
def generate_badges(total: int, easy: int, medium: int, hard: int) -> str:
    ...
    lines = [
        f"[![Solved](https://img.shields.io/badge/Solved-{total}-2563EB?style=for-the-badge&logo=leetcode&logoColor=white)](https://github.com/Saisrikar20/DBMS)",
        f"[![Easy](https://img.shields.io/badge/Easy-{easy}-22C55E?style=for-the-badge)](https://github.com/Saisrikar20/DBMS)",
        f"[![Medium](https://img.shields.io/badge/Medium-{medium}-F59E0B?style=for-the-badge)](https://github.com/Saisrikar20/DBMS)",
        f"[![Hard](https://img.shields.io/badge/Hard-{hard}-EF4444?style=for-the-badge)](https://github.com/Saisrikar20/DBMS)",
